...
public static class GraphicsCache
{
    ...
    public static readonly Texture2D GizmoBreakLink =
        ContentFinder<Texture2D>.Get("UI/Gizmo/UndergroundConveyor_BreakLink");

    public static readonly Texture2D GizmoSelectLinked =
        ContentFinder<Texture2D>.Get("UI/Gizmo/UndergroundConveyor_SelectLinked");

    public static readonly Material OverlayNoLink =
        MaterialPool.MatFrom("UI/Gizmo/UndergroundConveyor_Overlay_NoLink", ShaderDatabase.MetaOverlay);
}